...
namespace PruebaAzure.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Carnet,Id,Cedula,Nombre,Apellido1,Apellido2,Email,Telefono")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Carnet,Id,Cedula,Nombre,Apellido1,Apellido2,Email,Telefono")] Estudiante estudiante)
        {
            if (id != estudiante.Id)
            {
                return NotFound();
